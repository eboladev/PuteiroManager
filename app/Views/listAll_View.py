...
class listAll_View(QMainWindow):
    ...
    def initUI(self, data):
        ...
        tableClients = Table_Helper(self.clientTab, data, ['ID', 'Nome', 'Idade'])
        self.gridLayout_2.addWidget(tableClients, 0, 0, 1, 1)
        self.tabWidget.addTab(self.clientTab, ("Clients"))
        ...
        tableGirls = Table_Helper(self.employeeTab, data, ['ID', 'Nome', 'Idade'])
        self.gridLayout_3.addWidget(tableGirls, 0, 0, 1, 1)
        self.tabWidget.addTab(self.employeeTab, ("Girls"))
